/*
  Arduino-based Burglar and Fire Alarm System GPL Source Code
  Copyright (C) 2010-2012 mykh

  This file is part of the Arduino-based Burglar and Fire Alarm System GPL Source Code ("Alarm Source Code").

  Alarm Source Code is free software: you can redistribute it and/or modify
